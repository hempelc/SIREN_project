...
df["GenBank_binary"] = df["COI_sequences_on_GenBank"].apply(
...
result_df.loc[len(result_df)] = {"metric": "All", "count": 7926}
result_df.loc[len(result_df)] = {"metric": "Standardized", "count": 6935}
